...
echo '<div class="col-sm-12 mx-5 my-3">
              ...
              <div class="d-flex justify-content-around  align-align-items-center ">
                ...
                <div class="d-block">
                    <a type="button" class="btn btn-danger btn-sm me-1 mb-2  mx-2 text-center" href="../Controllers/remove_item.php?product_id='.$product_id.'&user_id='.$user_id.'&role='.$role.'"> X</a>
                </div>
                </div>
              </div>
